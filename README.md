...
Feedstock license: [BSD-3-Clause](https://github.com/AnacondaRecipes/pyrush/blob/main/LICENSE.txt)
...
`pyrush` can be installed with:

```
conda install pyrush
```
...
Updating pyrush-feedstock
========================

If you would like to improve the pyrush recipe or build a new
